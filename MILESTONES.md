...
| M5 | Script Pipeline | Week 7 | In progress | Approved `SCRIPT_PIPELINE_SPEC.md` v1.0; created the `Outlines` and `Scripts` tabs in the Milo Story Vault with approved schemas and human-review dropdowns. Next: build `Milo Outline Generator v0.1`. |
