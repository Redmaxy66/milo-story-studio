...
| Animation | Renderer-neutral authority, 24 fps rationale, contiguous in/out frames, 5,760 frames / 240 seconds, one authoritative narration binding, exact non-overlapping shot ranges or no-playback states, non-overlapping dialogue windows, complete voice dependencies, corrected action order, separated audio/production-note semantics, honest missing-asset states, lip-sync fallback, acceptance/revision/assembly boundaries and no renderer adapter. |
| Prompt bundle | 24 unique prompt IDs, exact source hashes, manifest synchronization, future reference-specification IDs without asset claims, approved episode-reference matching without canonisation, unresolved duration mapping, requested/observed separation, null live configuration and no provider authority. |
