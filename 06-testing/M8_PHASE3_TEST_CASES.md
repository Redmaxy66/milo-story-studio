...
| Approval package | Six repository-only templates: AP01–AP04 use controlled `APPROVED` decisions with reviewer, actual timestamp and explicit conditions; remediated AP05–AP06 remain `PENDING_REVIEW` with null decision/reviewer/time. |
